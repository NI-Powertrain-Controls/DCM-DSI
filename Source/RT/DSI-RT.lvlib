...
<Library LVVersion="16008000">
	...
	<Item Name="SubVIs" Type="Folder">
		...
		<Item Name="Engine" Type="Folder">
			...
			<Item Name="Engine-ChannelNames.vi" Type="VI" URL="../SubVIs/Engine-ChannelNames.vi"/>
			<Item Name="Engine-Channels.vi" Type="VI" URL="../SubVIs/Engine-Channels.vi"/>
			...
			<Item Name="Engine-RPC-PWMPumpA.vi" Type="VI" URL="../SubVIs/Engine-RPC-PWMPumpA.vi"/>
			<Item Name="Engine-RPC-PWMPumpB.vi" Type="VI" URL="../SubVIs/Engine-RPC-PWMPumpB.vi"/>
			<Item Name="Engine-RPC-SyncPumpA.vi" Type="VI" URL="../SubVIs/Engine-RPC-SyncPumpA.vi"/>
		...
		<Item Name="Hardware" Type="Folder">
			...
			<Item Name="Hardware-KnockResultsCalPoints.vi" Type="VI" URL="../SubVIs/Hardware-KnockResultsCalPoints.vi"/>
			<Item Name="Hardware-KnockSetupCalPoints.vi" Type="VI" URL="../SubVIs/Hardware-KnockSetupCalPoints.vi"/>
			<Item Name="Hardware-LEDs-Flash.vi" Type="VI" URL="../SubVIs/Hardware-LEDs-Flash.vi"/>
			<Item Name="Hardware-LEDs.vi" Type="VI" URL="../SubVIs/Hardware-LEDs.vi"/>
			<Item Name="Hardware-NOxDataCalPoints.vi" Type="VI" URL="../SubVIs/Hardware-NOxDataCalPoints.vi"/>
			<Item Name="Hardware-Phase2SensorsOutputCalPoints.vi" Type="VI" URL="../SubVIs/Hardware-Phase2SensorsOutputCalPoints.vi"/>
			<Item Name="Hardware-Phase2SensorsSetupCalPoints.vi" Type="VI" URL="../SubVIs/Hardware-Phase2SensorsSetupCalPoints.vi"/>
		...
		<Item Name="Support" Type="Folder">
			...
			<Item Name="NormalizeArray.vi" Type="VI" URL="../SubVIs/Support/NormalizeArray.vi"/>
			<Item Name="StopTarget.vi" Type="VI" URL="../SubVIs/Support/StopTarget.vi"/>
			<Item Name="SystemAIFilters.vi" Type="VI" URL="../SubVIs/Support/SystemAIFilters.vi"/>
			<Item Name="VariantToSGL.vi" Type="VI" URL="../SubVIs/Support/VariantToSGL.vi"/>
		</Item>
	...
	<Item Name="CANMessageHandler.vi" Type="VI" URL="../SubVIs/Support/CANMessageHandler.vi"/>
	<Item Name="Control.vi" Type="VI" URL="../Control.vi"/>
	<Item Name="CreateCANReadQueues.vi" Type="VI" URL="../SubVIs/Support/CreateCANReadQueues.vi"/>
	<Item Name="Engine-In.vi" Type="VI" URL="../Engine-In.vi"/>
	<Item Name="Engine-Out.vi" Type="VI" URL="../Engine-Out.vi"/>
	<Item Name="FilterCANFrames.vi" Type="VI" URL="../SubVIs/Support/FilterCANFrames.vi"/>
